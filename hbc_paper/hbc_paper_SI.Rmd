...
## 5.0 Temporal subsets: individual call statistical analysis 

### 5.1 'Clustered' data subset results 
...
### 5.2 'Isolated' data subset results 
...
## 6.0 Temporal subsets: window statistical analysis 
```{r echo=FALSE}
...
## 7.0 Calculating expected dominant frequency ranges due to Doppler shift
...
## 8.0 tFM echo-call overlap probabilities
