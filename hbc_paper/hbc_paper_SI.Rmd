...
## 2.0 Video annotation of bat flights in the cave (*Needs cleaning and finalisation from N and Aditya*)
...
## 8.0 Calculating expected dominant frequency ranges due to Doppler shift
...
include_graphics('../combined_analysis/doppler_shift_schematic.png')
```
