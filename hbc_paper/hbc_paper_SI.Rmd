...
## 1.0 Audio-video synchronisation: hardware and software implementations
...
## 2.0 Video annotation of bat flights in the cave
...
#### 4.1 Choosing the 'silent window threshold'
...
#### 4.2 Dominant frequency measurement
...
#### 4.3 FM terminal frequency measurement
...
## 5.0 Group-wise individual call measurements
...
## 6.0 Temporal subsets: individual call statistical analysis 

#### 6.1 'Clustered' data subset results 
...
#### 6.2 'Isolated' data subset results 
...
## 7.0 Temporal subsets: window statistical analysis 
```{r echo=FALSE}
...
## 8.0 Calculating estimated Doppler shifts in our study
...
## 9.0 tFM echo-call overlap probabilities
...
For *3* bats, an echo may be overlapped by two calls. The probability of echo-call overlap here is between `r tfm.probs[1]-tfm.probs[2]`%. Further details are in the Jupyter notebook titled ```tFM-overlaps.ipynb```.
