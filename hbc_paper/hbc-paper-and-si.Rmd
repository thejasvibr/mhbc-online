...
Comment execution status: NM + HRG comments till Section (\@ref(indcallmethods))
...
From the three components of each call, we measured specific parameters. For the CF component, we measured the peak frequency, RMS level and duration. The CF peak frequency was quantified because bats may shift their CF frequencies in the presence of conspecifics. For the FM components, we measured the lowest frequency (at 10 dB below the level of the peak frequency of the FM component), bandwidth (defined as difference between the CF peak frequency and the lowest frequency of the FM component), RMS level and duration. We also calculated the iFM/CF and tFM/CF level difference, i.e., the level of the iFM and tFM components relative to the CF component, because CF-FM bats independently vary the level of call components in a context specific manner [@tian1997echolocation;@lu2020echolocating].
