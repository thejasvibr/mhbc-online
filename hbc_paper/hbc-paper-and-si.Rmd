...
```{r circuitschematic, echo=FALSE, fig.cap='\\label{fig:circuitschematic} The circuit plan of the synchronisation signal splitter shown in Figure \\@ref(fig:breadboard)'}
