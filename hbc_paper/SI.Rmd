...
```{r multidomfreqsim, echo=FALSE, fig.cap="\\label{fig:multidomfreqsim} The distribution of dominant frequency ranges expected when a single bat echolocates (left), observed when a single bat (middle), and calculated when two bats fly. Violinplots indicate data distribution, horizontal lines indicate the 25, 50, and 75th percentiles."}
