...
num_post <- 5000
# convenience function to generate 95% highest posterior density interval
...
# ratios
tfmcf.ratio.mcoi <- tfmcfreclev.db.map.compint
ifmcf.ratio.mcoi <- ifmcfreclev.db.map.compint
# bandwidths
...
| tFM-CF ratio (dB)      | `r tfmcf.ratio.mcoi[1]`, (`r tfmcf.ratio.mcoi[2]`, `r tfmcf.ratio.mcoi[3]`)                 | - |
| iFM-CF ratio (dB)      | `r ifmcf.ratio.mcoi[1]`, (`r ifmcf.ratio.mcoi[2]`, `r ifmcf.ratio.mcoi[3]`)                 | - |
...
#                'Ratio, dB', 'Ratio, dB', rep('Bandwidth',2))
# diff.mean <- rbind(cfdurn.diff.hpd,            tfmdurn.fixefs.hpd[,2],     ifmdurn.fixefs.hpd[,2],
#                    cfpeak.fixefs.hpd[,2],      tfmlower.fixefs.hpd[,2],    ifmlower.fixefs.hpd[,2],
#                    cfreclev.fixefs.hpd[,2],    tfmreclev.fixefs.hpd[,2],   ifmreclev.fixefs.hpd[,2],
#                    tfmcfreclev.fixefs.hpd[,2], ifmcfreclev.fixefs.hpd[,2], 
#                    tfmbw.fixefs.hpd[,2],ifmbw.fixefs.hpd[,2])
# all.ind.summary <- cbind(component, parameter, diff.mean)
# row.names(all.ind.summary)[1]<-""
